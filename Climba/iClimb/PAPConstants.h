...
extern NSString *const kFalesieCountPerRegionCacheKey;
extern NSString *const kFavouriteFalesie;

#pragma mark - Parse Config strings
extern NSString *const kpcAuthorWebPageURL;
extern NSString *const kpcInviteFBFriendLink;
extern NSString *const kpcInviteFBFriendName;
extern NSString *const kpcInviteFBFriendCaption;
extern NSString *const kpcInviteFBFriendPicture;
extern NSString *const kpcInviteFBFriendLinkDescription;
extern NSString *const kpcAppWebSiteDomain;
