...
NSString *const kFalesieCountPerRegionCacheKey                              = @"it.ingenius.Climba.userDefaults.cache.falesieCountPerRegion";
NSString *const kFavouriteFalesie                                           = @"it.ingenius.Climba.userDefaults.cache.favouriteFalesieIdList";

#pragma mark - Parse Config strings
NSString *const kpcAuthorWebPageURL                                         = @"authorWebPageURL";
NSString *const kpcInviteFBFriendLink                                       = @"inviteFBFriendLink";
NSString *const kpcInviteFBFriendName                                       = @"inviteFBFriendName";
NSString *const kpcInviteFBFriendCaption                                    = @"inviteFBFriendCaption";
NSString *const kpcInviteFBFriendPicture                                    = @"inviteFBFriendPicture";
NSString *const kpcInviteFBFriendLinkDescription                            = @"inviteFBFriendLinkDescription";
NSString *const kpcAppWebSiteDomain                                         = @"appWebSiteDomain";
